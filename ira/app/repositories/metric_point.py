...
class MetricPointRepository:
        ...
        *,
        ...
        result = await self._session.exec(
            ...
            .where(
                ...
                MetricPoint.server_id == server_id,
    ...
    async def list_packet_loss_events(
        ...
        *,
        ...
        """
        Return aggregated packet loss events for a server within a time range.
        ...
        Parameters:
            server_id (str): Server identifier to filter packet loss events.
